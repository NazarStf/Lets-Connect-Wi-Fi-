		...
		ZStack{
			...
			ZStack {
				...
				Circle().fill(arcColor).scaleEffect(0.075).shadow(color: Color.blue, radius: 5).offset(y: circleOffset)
					.animation(Animation.easeOut(duration: animationDuration), value: circleOffset)
				...
				ZStack {
					ArcView(radius: 12, fillColor: $arcColor, shadowColor: $shadowColor)
						...
						.animation(Animation.easeOut(duration: animationDuration), value: smallArcOffset)
					
					ArcView(radius: 24, fillColor: $arcColor, shadowColor: $shadowColor)
						.rotationEffect(getRotation(arcBoolean: Self.rotateArc))
						.offset(y: mediumArcOffset)
						.animation(Animation.easeOut(duration: animationDuration).delay(animationDuration), value: mediumArcOffset)
					
					ArcView(radius: 36, fillColor: $arcColor, shadowColor: $shadowColor)
						.rotationEffect(getRotation(arcBoolean: Self.rotateArc))
						.offset(y: largeArcOffset)
						.animation(Animation.easeOut(duration: animationDuration).delay(animationDuration * 1.9), value: largeArcOffset)
